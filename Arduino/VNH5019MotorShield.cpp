...
VNH5019MotorShield::VNH5019MotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, 
...
void VNH5019MotorShield::setM1Speed(int speed)
{
...
void VNH5019MotorShield::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void VNH5019MotorShield::setSpeeds(int m1Speed, int m2Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
}
...
void VNH5019MotorShield::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void VNH5019MotorShield::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void VNH5019MotorShield::setBrakes(int m1Brake, int m2Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
}
...
unsigned int VNH5019MotorShield::getM1CurrentMilliamps()
{
...
unsigned int VNH5019MotorShield::getM2CurrentMilliamps()
{
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char VNH5019MotorShield::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char VNH5019MotorShield::getM2Fault()
{
